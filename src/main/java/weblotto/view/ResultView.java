...
public class ResultView {
    ...
    public void printLottoYield(LottoYield lottoYield) {
        System.out.println("총 수익률은 " + String.format("%.2f", lottoYield.yield())+ "입니. (기준이 1이기 때문에 결과적으로 " + lottoYield.stringYield() + "라는 의미임");
    }

    private void printLottoRank(LottoRank lottoRank, List<LottoTicket> lottoTickets, Numbers winnerNumber) {
